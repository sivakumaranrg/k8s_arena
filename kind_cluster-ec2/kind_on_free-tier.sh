...
# Step 9: Create a kind cluster with only a control-plane node (no workers)
echo "Creating a single-node kind cluster..."
...
export KUBECONFIG="$(kind get kubeconfig-path --name="devops-cluster")"
